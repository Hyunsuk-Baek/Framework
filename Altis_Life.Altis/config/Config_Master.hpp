...
/* System Settings */
    ...
    total_maxWeight = 28; //Static variable for the maximum weight allowed without having a backpack
    ...
    paycheck_civ = 35000; //Payment for civillians
    paycheck_med = 45000; //Payment for medics
